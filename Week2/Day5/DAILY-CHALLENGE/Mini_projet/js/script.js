function playTheGame() {
 ...
 //  la condition sur le number de l'utilisateur et du computer
  ...
  if(!nombre(reponse)){
   ...
   if(!NombreCompris(reponse)){
    //mettre un break pour arreter le programme de continuer
  ...
  //function permettant de verifier si l'utilisateur ne rentre pas un nombre compris entre 0 et 10
  //changer le nom de la variable Regex
 function nombre(str){
    const regex = new RegExp(/^[0-9]*$/)
    return regex.test(str)
 
 }
  //function permettant de generer un nombre compris en tre 0 et 10
  //changer le parametre de number
 function NombreCompris(number){
    //installer TODO sur vscode
    //TODO
 ...
 //function permettant de coparer le number de l'utilisateur et de l'odrdinateur
 function comparareNumber(userNumber, computerNumber){
    ...
    if(userNumber > computerNumber){
      alert("your number is bigger than for the computer, guess again")
    }else if(userNumber < computerNumber){
       alert("your number is smaller than for the computer, guess again")
